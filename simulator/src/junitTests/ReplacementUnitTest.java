...
public class ReplacementUnitTest {
	...
	Tuple replacementSim[] = {new Tuple("verificationfiles/replacementTopo", "verificationFiles/astypes_scion.txt", "verificationFiles/scionVeri.yml")};
	/**
	...
	public final void testBWExperiment(){
		for(Tuple experiment : replacementSim)
		{
			//Simulator simulator = new Simulator(); 
			//			annotatedBrite.txt asTypes.txt ..\results\result.txt --seed 1 --sim 4 --monitorFrom 3 --useBandwidth 0 --forX .1 --metric 1
			String arg = experiment.topoFile + " " + experiment.asTypes + " ../results/result.txt --seed 1 --sim 4 --monitorFrom 3 --useBandwidth 0 --forX .1 --metric 1 --maxPaths 15";
			...
			try {
				...
				{
					if(!veriInfo.verifyAS(aAS, VerificationInformation.REPLACEMENT))
					{
						verified = false;
					}
				}
