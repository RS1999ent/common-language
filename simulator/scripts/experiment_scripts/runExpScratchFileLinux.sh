...
echo "arg9 is whether to perfomr richworld"
astypesFile=$*astypes.txt
echo $astypesFile
echo "LEGEND "$8" ENDLEGEND\n"

python ../richWorldASTypes.py --seedWiser 1 ../../formattedData/annotatedBrite.txt ../../formattedData/"$astypesFile" --numTransits 0 --seedTransit 1 --sim $1 --randomMethod $7 --richworld $9
...
python ../richWorldASTypes.py --seedWiser 1 ../../formattedData/annotatedBrite.txt ../../formattedData/"$astypesFile" --numTransits 1 --seedTransit 1 --sim $1 --randomMethod $7 --richworld $9
