...
echo arg1 "is fraction to protocols" 
...
echo "LEGEND "$7" ENDLEGEND\n"
	...
	python ../richWorldASTypes.py --seedWiser 1 ../../formattedData/annotatedBrite.txt ../../formattedData/"$astypesFile" --numTransits $1 --seedTransit $i --sim 501
